			...
			<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 manascommheader">
				...
				<%-- <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1 oneseticonleft">
                                ...
                                <a class="btn btn-danger dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <% if(loginfo.getSuperadminid()==1){%>
                                    	Welcome, <%=loginfo.getFirstName()%> <i class="fa fa-angle-down"></i>
                                    <%}else{ %>
                                    	Hi, <%=loginfo.getFirstName()%> <i class="fa fa-angle-down"></i>
                                    <% }%>
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink" style="min-width: 5rem !important">
                                	...
                                	<!--  <a class="dropdown-item" href="logoutwithsessionLogout"><i class="fa fa-sign-out"></i>&nbsp;Logout With Session</a> -->
                                		...
                                		<%if(!loginfo.getLoginType().equals("mob")){ %>
                                			<%if(loginfo.isLmh()){ %>
					...
					<table
						...
						<thead>
							...
							<tr>
								...
								<th class="manastableheader noExl">Client Type</th>
								<th class="manastableheader noExl">Remark</th>
							...
							<s:if test="allPatientList.size!=0">
								...
								<s:iterator value="allPatientList" status="rowstatus">
									<tr id="<s:property value="id" />">
										...
										<td class="noExl"><s:property value="ClientType" /></td>
										<td class="noExl"><s:property value="Note" /></td>
