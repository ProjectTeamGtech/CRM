                ...
                <div class="row pd-header" >
                    <div class="col-lg-7 col-md-7 col-12 " >
                      ...
                      <div class="col txt-left" style="padding-top: 40px">
                          <h2>Welcome To Manas YuviCare Hospital Information Management System<br>
                          <span style="font-weight: 600;color:black"> A Hospital Information Management System With All Management Functionality</span></h2>    
                      </div>
                      <div class="col lf-yi" style="margin-top: -70px;">       
                        <img src="manaslogin/images/Yuvicare_Illustration.png" > 
                      </div>
